      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            ...
            <span
              className=" dropdown show hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer  "
              onClick={(e) => history.push("#")}
            >
              <a
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item" href="/instalation">
                  Installation
                </a>
                <a class="dropdown-item" href="/reparation">
                  Reparation
                </a>
              </div>
            </span>
        ...
        <div
          className={
            data.navbershop && data.navbershop
